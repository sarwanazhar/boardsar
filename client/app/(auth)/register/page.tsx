...
function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (password !== confirmPassword) {
      clearError()
      // Set error manually since store doesn't handle this
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center p-6 md:p-12 z-10">
        ...
        <main className="w-full max-w-md lg:max-w-lg">
          <div className="mb-10 text-center">
            <h1 className="text-white tracking-tight text-5xl md:text-7xl font-bold leading-tight pb-4">Start The Journey</h1>
            <p className="text-gray-400 text-lg md:text-xl font-medium">Start your creative journey with a free account.</p>
          </div>
          ...
          <div className="w-full bg-[#1b2210]/95 backdrop-blur-md p-8 md:p-12 sketch-border border-white/20">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col gap-2">
                <label className="flex flex-col group">
                  <span className="text-white/80 text-xs md:text-sm font-bold leading-normal pb-3 px-1 uppercase tracking-widest">Confirm Password</span>
                  <div className="purple-glow transition-all duration-300 flex w-full items-stretch rounded-full border-2 border-white/10 overflow-hidden bg-[#22271b]">
                    <input
                      className="form-input flex w-full border-none bg-transparent h-14 md:h-16 placeholder:text-gray-600 text-white px-6 text-lg font-normal focus:ring-0"
                      placeholder="••••••••"
              ...
              >
                ...
                <span className="material-symbols-outlined text-3xl font-black group-hover:translate-x-2 transition-transform">add</span>
              </button>
            </form>
